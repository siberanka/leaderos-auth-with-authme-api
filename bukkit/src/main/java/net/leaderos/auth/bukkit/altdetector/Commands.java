...
import net.leaderos.auth.bukkit.altdetector.database.Database.PlayerDataType;
...
public class Commands implements CommandExecutor
{
    ...
    public Commands(AltDetectorController plugin)
    {
        this.plugin = plugin;
    }
    ...
    private void sendMessageSync(final CommandSender sender, final List<String> messages)
    {
        ...
        Bukkit.getScheduler().runTask(plugin.getMainPlugin(), new Runnable()
        {
            @Override
            public void run() {
