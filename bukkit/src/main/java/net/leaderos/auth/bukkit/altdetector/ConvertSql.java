...
import net.leaderos.auth.bukkit.altdetector.database.Database.IptableType;
import net.leaderos.auth.bukkit.altdetector.database.Database.PlayertableType;
...
public class ConvertSql
{
    ...
    public ConvertSql(AltDetectorController plugin)
    {
        this.plugin = plugin;
    }
