...
public class Mysql extends Database
{
    ...
    public Mysql(AltDetectorController plugin, boolean debug, String prefix)
    {
        ...
        countAccountsByIp = "SELECT COUNT(DISTINCT playerid) AS account_count FROM {prefix}iptable WHERE ipaddr = ? AND date >= SUBDATE(now(),?);";
